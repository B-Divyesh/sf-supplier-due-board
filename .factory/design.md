...
- **Delivery:** responsive 768px and 1536px WebP plus 768px and 1536px AVIF. The 390px layout intentionally crops the material study into a shallow 144–176px band, and its 768px AVIF is 66,655 bytes. `public/social-card.jpg` is a hand-cropped 1200×630 derivative of the retained generated source for Open Graph and Twitter cards. All hero variants are below the 300 KB mobile-image limit.
